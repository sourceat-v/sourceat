...
let TRENDS = [
  {
    ...
    products:[
      ...
      { product_id:'b8', search:'buldak kimchi ramen', search_kr:'불닭볶음면 김치', name:'Buldak Kimchi (5pk)', brand:'Samyang', desc:'Kimchi tang layered with fire chicken heat. Tangy, funky, and spicy all at once.', img_url:'https://img08.weeecdn.net/product/image/273/659/3E9D8AD78C3A1C82.png!c864x0_q80.auto', shops:{ hmart:{price:8.99,url:'https://www.hmart.com'}, weee:{price:9.49,url:'https://www.sayweee.com'}, wooltari:{price:8.99,url:'https://www.wooltariusa.com'}, amazon:{price:12.99,url:'https://www.amazon.com/s?k=samyang+buldak+kimchi+ramen'}, yamibuy:{price:9.49,url:'https://www.yami.com/search?q=samyang+buldak+kimchi'} } },
  ...
  },
  {
    ...
    products:[
      ...
      { product_id:'t2', search:'tteokbokki carbonara', search_kr:'삼양 까르보 떡볶이', name:'Carbonara Tteokbokki', brand:'Samyang', desc:'Rose sauce meets chewy rice cakes. Creamy and mildly spicy.', img_url:'https://img08.weeecdn.net/product/image/349/331/5E1A19F0FE0CD05A.png!c864x0_q80.auto', img_fallbacks:['https://img08.weeecdn.net/product/image/638/139/2CF3F62717F42AEC.png!c864x0_q80.auto'], shops:{ hmart:{price:3.99,url:'https://www.hmart.com'}, weee:{price:null,url:null}, wooltari:{price:3.89,url:'https://www.wooltariusa.com'}, amazon:{price:5.99,url:'https://www.amazon.com/s?k=samyang+carbonara+tteokbokki'}, yamibuy:{price:4.49,url:'https://www.yami.com/search?q=samyang+carbonara+tteokbokki'} } },
