...
function resolveShopUrl(key, url, search) {
  if (!url) return null;
...
function openModal(id) {
  ...
  document.getElementById('modal-shops').innerHTML = SHOPS.map(sh => {
    ...
    const href = resolveShopUrl(sh.key, s.url, p.search || p.brand);
    return href
